...
fn new_art_exp01() {
    ...
    assert_eq!(
        ...
        HashMap::from([
            (
                Pixels {
                    square: vec![vec![0, 0], vec![0, 1]]
                },
                Pixels {
                    square: vec![vec![1, 1, 0], vec![1, 0, 0], vec![0, 0, 0]]
                }
            ),
            (
                Pixels {
                    square: vec![vec![0, 0], vec![1, 0]]
                },
                Pixels {
                    square: vec![vec![1, 1, 0], vec![1, 0, 0], vec![0, 0, 0]]
                }
            ...
            (
                Pixels {
                    square: vec![vec![1, 1, 1], vec![0, 0, 1], vec![0, 1, 0]]
                },
                Pixels {
                    square: vec![
                        vec![1, 0, 0, 1],
            ...
            (
                Pixels {
                    square: vec![vec![0, 1, 0], vec![1, 0, 0], vec![1, 1, 1]]
                },
                Pixels {
                    square: vec![
                        vec![1, 0, 0, 1],
            ...
            (
                Pixels {
                    square: vec![vec![0, 1, 1], vec![1, 0, 1], vec![0, 0, 1]]
                },
                Pixels {
                    square: vec![
                        vec![1, 0, 0, 1],
            ...
            (
                Pixels {
                    square: vec![vec![1, 1, 1], vec![1, 0, 0], vec![0, 1, 0]]
                },
                Pixels {
                    square: vec![
                        vec![1, 0, 0, 1],
            ...
            (
                Pixels {
                    square: vec![vec![1, 0, 0], vec![1, 0, 1], vec![1, 1, 0]]
                },
                Pixels {
                    square: vec![
                        vec![1, 0, 0, 1],
            ...
            (
                Pixels {
                    square: vec![vec![0, 0, 1], vec![0, 1, 1], vec![1, 0, 1]]
                },
                Pixels {
                    square: vec![
                        vec![1, 0, 0, 1],
            ...
            (
                Pixels {
                    square: vec![vec![0, 1, 0], vec![1, 1, 1], vec![1, 0, 0]]
                },
                Pixels {
                    square: vec![
                        vec![1, 0, 0, 1],
            ...
            (
                Pixels {
                    square: vec![vec![1, 1, 0], vec![1, 0, 0], vec![1, 0, 1]]
                },
                Pixels {
                    square: vec![
                        vec![1, 0, 0, 1],
            ...
            (
                Pixels {
                    square: vec![vec![1, 1, 0], vec![1, 0, 1], vec![1, 0, 0]]
                },
                Pixels {
                    square: vec![
                        vec![1, 0, 0, 1],
            ...
            (
                Pixels {
                    square: vec![vec![0, 0, 1], vec![1, 0, 1], vec![0, 1, 1]]
                },
                Pixels {
                    square: vec![
                        vec![1, 0, 0, 1],
