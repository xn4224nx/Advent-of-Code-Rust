...
fn execute_cmd_exp11() {
    ...
    test.execute_cmd(0);
    assert_eq!(test.register, vec![14]);
    assert_eq!(test.cmd_idx, 1);
}
...
fn execute_cmd_exp12() {
    let mut test = Duo::new("./data/example_01.txt");
    test.register = vec![5, 16];
    test.instructions = vec![Cmd::JgzReg(1, 0)];
    test.execute_cmd(0);
    assert_eq!(test.register, vec![5, 1]);
    assert_eq!(test.cmd_idx, 1);
}
...
fn execute_cmd_exp13() {
    let mut test = Duo::new("./data/example_01.txt");
    test.register = vec![3];
    test.instructions = vec![Cmd::JgzReg(0, 7)];
    test.execute_cmd(0);
    assert_eq!(test.register, vec![3]);
...
fn execute_cmd_exp15() {
    let mut test = Duo::new("./data/example_01.txt");
    test.instructions = vec![Cmd::JgzVal(1, 7)];
    test.execute_cmd(0);
    assert_eq!(test.cmd_idx, 7);
}
...
fn execute_cmd_exp16() {
    let mut test = Duo::new("./data/example_01.txt");
    test.instructions = vec![Cmd::JgzVal(0, 7)];
    test.execute_cmd(0);
    assert_eq!(test.cmd_idx, 1);
}
