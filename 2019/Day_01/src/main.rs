 ...
 *
 * PART 1:  What is the sum of the fuel requirements for all of the modules on
 *          your spacecraft?
 *
 ...
 *
 * PART 2:  What is the sum of the fuel requirements for all of the modules on
...
impl Rocket {
    ...
    pub fn mod_fuel_req(module_mass: usize, account_for_fuel: bool) -> usize {
        return if account_for_fuel {
            let mut fuel = 0;
            let mut tmp_mass = module_mass;
    ...
    pub fn fuel_reqs(self, account_for_fuel: bool) -> usize {
        return self
            .module_masses
            .iter()
            .map(|x| Self::mod_fuel_req(*x, account_for_fuel))
            .sum::<usize>();
    }
}
...
fn main() {
    println!(
        "Part 1 = {}\nPart 2 = {}\n",
        Rocket::new("./data/input_0.txt").fuel_reqs(false),
        Rocket::new("./data/input_0.txt").fuel_reqs(true),
    );
}
