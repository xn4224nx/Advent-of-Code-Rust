...
fn is_char_hash_exp1() {
    assert_eq!(is_char_hash(md5_idx_hash("abc".to_string(), 3231929)), true)
}

#[test]
fn is_char_hash_exp2() {
    assert_eq!(is_char_hash(md5_idx_hash("abc".to_string(), 5017308)), true)
}

#[test]
fn is_char_hash_exp3() {
    assert_eq!(is_char_hash(md5_idx_hash("abc".to_string(), 5278568)), true)
}
