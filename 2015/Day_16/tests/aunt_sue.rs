...
fn could_aunt_match_01() {
    ...
    assert_eq!(could_aunt_match(true_aunt, pos_aunt), false);
}
...
fn could_aunt_match_05() {
    ...
    assert_eq!(could_aunt_match(true_aunt, pos_aunt), true);
}
...
#[test]
fn find_true_aunt_index_exp() {
    let true_aunt = &read_aunt_data("./data/p1_aunt.txt")[0];
    let all_aunts = &read_aunt_data("./data/p1_example_aunts.txt");
    assert_eq!(find_true_aunt_index(true_aunt, all_aunts), 5);
}
